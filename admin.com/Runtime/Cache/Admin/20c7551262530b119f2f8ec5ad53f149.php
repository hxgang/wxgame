...
.explode {
  background:url(http://www.19890407.com/Public/Admin/images/menu_minus.gif) no-repeat 0px 3px;
  font-weight:bold;
}
.collapse {
  background:url(http://www.19890407.com/Public/Admin/images/menu_plus.gif) no-repeat 0px 3px;
  font-weight:bold;
}
.menu-item {
  background:url(http://www.19890407.com/Public/Admin/images/menu_arrow.gif) no-repeat 0px 3px;
  font-weight:normal;
}
#help-title {
  font-size:14px;
    ...
    <p>
        <span style="float:right; padding:3px 5px;" >
            <a href="javascript:toggleCollapse();">
                <img id="toggleImg" src="http://www.19890407.com/Public/Admin/images/menu_minus.gif" width="9" height="9" border="0" alt="闭合" />
            </a>
        </span>
...
<script type="text/javascript" src="http://www.19890407.com/Public/Admin/js/global.js"></script>
<script type="text/javascript" src="http://www.19890407.com/Public/Admin/js/utils.js"></script>
<script type="text/javascript" src="http://www.19890407.com/Public/Admin/js/transport.js"></script>
<script language="JavaScript">
    ...
    function toggleCollapse() {
        ...
        collapse = !collapse;
        document.getElementById('toggleImg').src = collapse ? 'http://www.19890407.com/Public/Admin/images/menu_minus.gif' : 'http://www.19890407.com/Public/Admin/images/menu_plus.gif';
