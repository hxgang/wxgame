            ...
            <div class="am-g">
                <div class="am-u-sm-12 am-u-md-6">
                    <div class="am-btn-toolbar">
                        <div class="am-btn-group am-btn-group-xs"><a href="<?php echo U('edit');?>" title="新增">
                    ...
                    <form class="am-form">
                        <table class="am-table am-table-striped am-table-hover table-main">
                            ...
                            <tr>
                                ...
                                <th  class="table-typ">操作</th>
                            </tr>
                            </thead>
                            <tbody>
                            <?php if(is_array($data["list"])): $i = 0; $__LIST__ = $data["list"];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$row): $mod = ($i % 2 );++$i;?><tr>
                                    <td><?php echo ($row["name"]); ?></td>
                                    <td><?php echo ($row["shop_price"]); ?></td>
                                    <td><?php echo ($row["stock"]); ?></td>
                                    <td>
                                        <?php switch($row["status"]): case "1": ?>正常<?php break;?>
                                            <?php case "0": ?>停用<?php break;?>
                                            <?php case "-1": ?>已删除<?php break; endswitch;?>
                                    </td>
                                    <td>
                                        <a href="<?php echo U('edit',array('id'=>$row['id']));?>" title="编辑">编辑</a> |
                                        <a class="ajax-get" href="<?php echo U('changeStatus',array('id'=>$row['id']));?>" title="删除">删除</a>
                                    </td>
