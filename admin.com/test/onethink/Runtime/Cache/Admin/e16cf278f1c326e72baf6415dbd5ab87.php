...
<head>
    ...
    <link href="/test/onethink/Public/favicon.ico" type="image/x-icon" rel="shortcut icon">
    <link rel="stylesheet" type="text/css" href="/test/onethink/Public/Admin/css/base.css" media="all">
    <link rel="stylesheet" type="text/css" href="/test/onethink/Public/Admin/css/common.css" media="all">
    <link rel="stylesheet" type="text/css" href="/test/onethink/Public/Admin/css/module.css">
    <link rel="stylesheet" type="text/css" href="/test/onethink/Public/Admin/css/style.css" media="all">
	<link rel="stylesheet" type="text/css" href="/test/onethink/Public/Admin/css/<?php echo (C("COLOR_STYLE")); ?>.css" media="all">
     <!--[if lt IE 9]>
    ...
    <script type="text/javascript" src="/test/onethink/Public/Admin/js/jquery.mousewheel.js"></script>
    <!--<![endif]-->
...
<script>
	...
	<script type="text/javascript" src="/test/onethink/Public/static/uploadify/jquery.uploadify.min.js"></script>
...
<div class="tab-wrap">
                        ...
                        <?php switch($field["type"]): case "num": ?><input type="text" class="text input-medium" name="<?php echo ($field["name"]); ?>" value="<?php echo ($field["value"]); ?>"><?php break;?>
                            ...
                            <?php case "picture": ?><div class="controls">
								...
								$("#upload_picture_<?php echo ($field["name"]); ?>").uploadify({
							        "height"          : 30,
							        "swf"             : "/test/onethink/Public/static/uploadify/uploadify.swf",
								...
								function uploadPicture<?php echo ($field["name"]); ?>(file, data){
							        ...
							        if(data.status){
							        	...
							        	src = data.url || '/test/onethink' + data.path
							        	$("#cover_id_<?php echo ($field["name"]); ?>").parent().find('.upload-img-box').html(
							        		'<div class="upload-pre-item"><img src="/test/onethink' + src + '"/></div>'
							        	);
							        } else {
    ...
    <script type="text/javascript" src="/test/onethink/Public/static/think.js"></script>
    <script type="text/javascript" src="/test/onethink/Public/Admin/js/common.js"></script>
    <script type="text/javascript">
        +function(){
...
<link href="/test/onethink/Public/static/datetimepicker/css/datetimepicker.css" rel="stylesheet" type="text/css">
<?php if(C('COLOR_STYLE')=='blue_color') echo '<link href="/test/onethink/Public/static/datetimepicker/css/datetimepicker_blue.css" rel="stylesheet" type="text/css">'; ?>
<link href="/test/onethink/Public/static/datetimepicker/css/dropdown.css" rel="stylesheet" type="text/css">
<script type="text/javascript" src="/test/onethink/Public/static/datetimepicker/js/bootstrap-datetimepicker.min.js"></script>
<script type="text/javascript" src="/test/onethink/Public/static/datetimepicker/js/locales/bootstrap-datetimepicker.zh-CN.js" charset="UTF-8"></script>
<script type="text/javascript">
